john = User.create!(
  ...
  Item.create!(
    [
      ...
      {
        title: "Eric is Cool!",
        description: "This is a thing that says how cool Eric is",
        user: eric,
        image_url: "https://upload.wikimedia.org/wikipedia/commons/d/d5/Dog_chillin%27_with_red_sunglasses_%283545177630%29.jpg"
      }
    ]
  )